...
INLUDES = genlist.h genoutput.h error.h pasm64.h node.h opcodes.h symbol.h pasm64.tab.h str.h dictionary.h

all: $(TARGET)

$(OBJ_DIR)pasm64.o: pasm64.c $(INLUDES)
	$(CC) $(CFLAGS) -c -o $(OBJ_DIR)pasm64.o pasm64.c

$(OBJ_DIR)symbol.o: symbol.c $(INLUDES)
	$(CC) $(CFLAGS) -c -o $(OBJ_DIR)symbol.o symbol.c

$(OBJ_DIR)node.o: node.c $(INLUDES)
	$(CC) $(CFLAGS) -c -o $(OBJ_DIR)node.o node.c

$(OBJ_DIR)opcodes.o: opcodes.c $(INLUDES)
	$(CC) $(CFLAGS) -c -o $(OBJ_DIR)opcodes.o opcodes.c

$(OBJ_DIR)genlist.o: genlist.c $(INLUDES)
	$(CC) $(CFLAGS) -c -o $(OBJ_DIR)genlist.o genlist.c

$(OBJ_DIR)genoutput.o: genoutput.c $(INLUDES)
	$(CC) $(CFLAGS) -c -o $(OBJ_DIR)genoutput.o genoutput.c

$(OBJ_DIR)main.o: main.c $(INLUDES)
	$(CC) $(CFLAGS) -c -o $(OBJ_DIR)main.o main.c

$(OBJ_DIR)dictionary.o: dictionary.c $(INLUDES)
	$(CC) $(CFLAGS) -c -o $(OBJ_DIR)dictionary.o dictionary.c

$(OBJ_DIR)error.o: error.c $(INLUDES)
	$(CC) $(CFLAGS) -c -o $(OBJ_DIR)error.o error.c
...
$(OBJ_DIR)pasm64.flex.o: pasm64.flex.c $(INLUDES)
	$(CC) $(CFLAGS) -c -o $(OBJ_DIR)pasm64.flex.o pasm64.flex.c
